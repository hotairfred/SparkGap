#!/usr/bin/env python3
"""Score UHSDR + ML + bmorse(DSP-WPM-floored) + HamFist quad ensemble on CWT.
v7: DSP WPM estimator with floor at 25 WPM for contest CW coverage."""
...
for si, (freq_hz, snr) in enumerate(clustered):
    ...
    wpm = max(dsp_wpm, 25) if dsp_conf > 0.3 and dsp_wpm > 0 else 25  # floor at 25 for contest CW
